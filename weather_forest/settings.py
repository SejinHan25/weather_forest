"""
Django settings for weather_forest project.
...
SECRET_KEY = "django-insecure-bnb32(ztohd#t=cw4t2v0xpwry-j)qjq#@c7kan)_r*7)3zua="
...
ROOT_URLCONF = "weather_forest.urls"
...
WSGI_APPLICATION = "weather_forest.wsgi.application"
